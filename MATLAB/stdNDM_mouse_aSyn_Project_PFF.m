function outputs = stdNDM_mouse_aSyn_Project_PFF(varargin)
% STDNDM_MOUSE_ASYN_PROJECT_PFF Fit the global directional eNDM to PFF data.
%
...
%
% The current PFF model jointly fits the median regional pathology maps at
...
if ~logical(ipR.bootstrapping)
    ...
    pathology = [ ...
        median(Pathology_Data.PFF_Individual_3_MPI, 2), ...
    ...
    %
    % The original w_dir behavior is preserved. When w_dir is false,
    % directionality is initialized at 0.5 and fitted within [0,1].
